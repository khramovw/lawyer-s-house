...
module.exports = "<div class=\"maps\" [ngClass]=\"styleConfig\">\n\n  <div class=\"gmap\">\n\n    <div class=\"gmap-row\">\n\n      <div id='gmap_canvas'></div>\n\n    </div>\n\n  </div>\n\n</div>\n"
...
var GmapsComponent = /** @class */ (function () {
    ...
    ], GmapsComponent.prototype, "styleConfig", void 0);
...
var BatchPropositionComponent = /** @class */ (function () {
        ...
        this.bach = [
            {
                ...
                imgBatchPath: this.imgpath + "doclarge.jpeg",
                cardactions: "",
            },
            {
                title: "",
    ...
    BatchPropositionComponent.prototype.sliderModal = function (slide) {
        ...
        this.bach.filter(function (el, i) {
            ...
            if (i + 1 === slide) {
                _this.sldeModalImg = el.imgBatchPath;
            }
        });
    };
...
module.exports = "\r\n.usful {\r\n  background-color: #FAFAFA;\r\n}\r\n.usful .title {\r\n  font-size: 1.375em;\r\n  font-weight: 600;\r\n  height: 6.25em;\r\n  align-items: center;\r\n  display: flex;\r\n}\r\n.item-box {\r\n  display: flex;\r\n  width: 100%;\r\n  height: 40.8125em;\r\n}\r\n.item-box .box-col{\r\n  width: 50%;\r\n  height: inherit;\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: space-between;\r\n}\r\n.tab-wrapper {\r\n  padding: 2.4375em 2.4375em 0;\r\n}\r\n.tab-wrapper ul {\r\n  margin-top: 1.375em;\r\n  display: flex;\r\n}\r\n.tab-wrapper > ul li {\r\n  width: 10.4375em;\r\n  text-align: center;\r\n  padding: .375em 0;\r\n  font-size: .875em;\r\n  font-weight: 400;\r\n  border-top: .125em solid transparent;\r\n  cursor: pointer;\r\n}\r\n.tab-wrapper > ul li:not(.is-open) {\r\n  background-color: #F6F6F6;\r\n}\r\n.tab-wrapper > ul li.is-open {\r\n  border-top: .125em solid #0067B8;\r\n  box-shadow: .1875em -.25em .625em rgba(196, 196, 196, .16);\r\n}\r\n.tab-content {\r\n  border-top: 1px solid #F1F1F1;\r\n}\r\n.tab-content ul {\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n.tab-content ul li {\r\n  margin-bottom: 6px;\r\n}\r\n.row-content {\r\n  display: flex;\r\n  font-size: 1em;\r\n}\r\n.row-content .title {\r\n  font-weight: 600;\r\n  min-width: 8.75em;\r\n  max-width: 8.75em;\r\n}\r\n.row-content .description {\r\n  font-weight: 400;\r\n  position: relative;\r\n}\r\n.row-content .description img {\r\n  position: absolute;\r\n  right: -5em;\r\n  top: -.8125em;\r\n}\r\n.item-tab:not(.is-open){\r\n  display: none;\r\n}\r\n.active-box {\r\n  width: 100%;\r\n  height: 7.4375em;\r\n  display: flex;\r\n}\r\n.active-box .active-item {\r\n  width: 50%;\r\n  height: inherit;\r\n  align-items: center;\r\n  justify-content: center;\r\n  flex-direction: column;\r\n  display: flex;\r\n  cursor: pointer;\r\n}\r\n.active-item span {\r\n  font-weight: 600;\r\n  font-size: 1.0625em;\r\n  color: #7A7A7A;\r\n}\r\n.active-item.active-color {\r\n  background-color: #0E76BC;\r\n}\r\n.active-item.active-color span {\r\n  color: white;\r\n}\r\n.active-item img {\r\n  height: 2.3275em;\r\n}\r\n"
...
module.exports = "<app-header></app-header>\n\n<section class=\"item-box\">\n  <div class=\"box-col\">\n    <div class=\"tab-wrapper\">\n      <h1 class=\"h1\">Верховний суд України</h1>\n      <ul #btnTabs>\n        <li class=\"is-open\">Інформація</li>\n        <li>Дані судового збору</li>\n      </ul>\n      <div class=\"tab-content\">\n        <div [ngClass]=\"{'is-open':!tabscont}\" class=\"item-tab is-open\">\n          <ul>\n            <li class=\"row-content\" *ngFor=\"let row of info\">\n              <div class=\"title\">{{ row.title}}</div>\n              <div class=\"description\">{{ row.description}} <img src=\"{{row.photoPath}}\" alt=\"\"></div>\n            </li>\n          </ul>\n        </div>\n        <div [ngClass]=\"{'is-open':tabscont}\" class=\"item-tab\">\n          <ul>\n            <li class=\"row-content\" *ngFor=\"let row of shipboardData\">\n              <div class=\"title\">{{ row.title}}\n              </div>\n              <div class=\"description\">{{ row.description}} <span><img src=\"{{ row.photoPath }}\" alt=\"\"></span></div>\n            </li>\n          </ul>\n        </div>\n      </div>\n    </div>\n    <div class=\"active-box\">\n      <div class=\"active-item active-color\">\n        <img src=\"assets/img/noun_Document.svg\" alt=\"\">\n        <span>Підготувати заяву до цього органу</span>\n      </div>\n      <div class=\"active-item\">\n        <img src=\"assets/img/noun_support.svg\" alt=\"\">\n        <span>Консультація з юристом</span>\n      </div>\n    </div>\n  </div>\n  <div class=\"box-col\">\n    <app-gmaps [styleConfig]=\"itemBoxStyle\"></app-gmaps>\n  </div>\n</section>\n\n\n<section class=\"usful\">\n  <div class=\"container\">\n\n    <div class=\"title\">Корисні документи</div>\n    <app-main-nav [mainnavigation]=\"usefulDocuments\" [mainNavStyle]=\"uswfulDocStyle\"></app-main-nav>\n\n  </div>\n</section>\n\n\n\n<div class=\"container\">\n  <app-best-decision></app-best-decision>\n</div>\n\n<app-footer></app-footer>\n\n\n"
...
var GovernmentAgencyComponent = /** @class */ (function () {
    function GovernmentAgencyComponent() {
        ...
        this.shipboardData = [
            { title: 'ДМ Одержувач:', description: 'УК у Печер. р-ні/Печерс. р-н/22030102' },
            { title: 'ДМ ЄДРПОУ:', description: '38004897' },
            { title: 'Банк одержувача:', description: 'Казначейство України (ЕАП)' },
            { title: 'ДМ ЄДРПОУ:', description: '899998' },
            { title: 'ДМ Рахунок:', description: '31219207026007' },
            { title: 'ДМ Код платежу за бюджетною класифікацією:', description: '22030102 «Судовий збір (Верховний Суд, 055)»' },
            {
                title: 'ДМ Призначення платежу:',
                description: "*;101;__________(\u043A\u043E\u0434 \u043A\u043B\u0456\u0454\u043D\u0442\u0430 \u0437\u0430 \u0404\u0414\u0420\u041F\u041E\u0423 \u0434\u043B\u044F \u044E\u0440\u0438\u0434\u0438\u0447\u043D\u0438\u0445 \u043E\u0441\u0456\u0431\n     (\u0434\u043E\u043F\u043E\u0432\u043D\u044E\u0454\u0442\u044C\u0441\u044F \u0437\u043B\u0456\u0432\u0430 \u043D\u0443\u043B\u044F\u043C\u0438 \u0434\u043E \u0432\u043E\u0441\u044C\u043C\u0438 \u0446\u0438\u0444\u0440, \u044F\u043A\u0449\u043E \u0437\u043D\u0430\u0447\u0443\u0449\u0438\u0445 \u0446\u0438\u0444\u0440 \u043C\u0435\u043D\u0448\u0435 8),\n      \u0440\u0435\u0454\u0441\u0442\u0440\u0430\u0446\u0456\u0439\u043D\u0438\u0439 \u043D\u043E\u043C\u0435\u0440 \u043E\u0431\u043B\u0456\u043A\u043E\u0432\u043E\u0457 \u043A\u0430\u0440\u0442\u043A\u0438 \u043F\u043B\u0430\u0442\u043D\u0438\u043A\u0430 \u043F\u043E\u0434\u0430\u0442\u043A\u0456\u0432 \u2013 \u0444\u0456\u0437\u0438\u0447\u043D\u043E\u0457 \u043E\u0441\u043E\u0431\u0438\n       (\u0437\u0430\u0432\u0436\u0434\u0438 \u043C\u0430\u0454 10 \u0446\u0438\u0444\u0440) \u0430\u0431\u043E \u0441\u0435\u0440\u0456\u044F \u0442\u0430 \u043D\u043E\u043C\u0435\u0440 \u043F\u0430\u0441\u043F\u043E\u0440\u0442\u0430 \u0433\u0440\u043E\u043C"
            },
        ];
        this.info = [
            { title: 'Голова:', description: 'Святошина Галина Михайлівна', photoPath: 'assets/img/dred.png' },
            { title: 'Адреса:', description: 'м. Київ, вул. Пилипа Орлика, 8' },
            { title: 'Область:', description: 'Київська область' },
            { title: 'Індекс:', description: '01043' },
            { title: 'Телефон:', description: '(044) 591-10-00, 0-800-501-492' },
            { title: 'Веб-сайт:', description: 'http://supreme.court.gov.ua/supreme/' },
            { title: 'Email:', description: "inbox@supreme.court.gov.ua" },
        ];
    }
    ...
    GovernmentAgencyComponent.prototype.htmlColiToObj = function (e) {
        return [].slice.call(e);
    };
    GovernmentAgencyComponent.prototype.onTab = function () {
        var _this = this;
        this.tabs = this.htmlColiToObj(this.btnTabs.nativeElement.children);
        console.log(this.tabscont);
        this.tabs.find(function (tab) { return tab.addEventListener('click', function (el) {
            _this.offTab(_this.tabs);
            el.target.classList.add('is-open');
            _this.tabscont = !_this.tabscont;
        }); });
    };
    GovernmentAgencyComponent.prototype.offTab = function (obj) {
        obj.filter(function (el) { return el.classList.remove('is-open'); });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('btnTabs'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], GovernmentAgencyComponent.prototype, "btnTabs", void 0);
